(function(){
  ...
  function init(){
    ...
    gate.innerHTML = ''
      ...
      +   '</svg>'
      +   '<h1 style="font-weight:400;font-size:36px;margin:0 0 10px;letter-spacing:0.01em;line-height:1">C<em style="color:#b03a0a;font-style:italic">e</em>sty</h1>'
      +   '<p style="font-size:11px;opacity:0.55;margin:0 0 28px;letter-spacing:0.22em;text-transform:uppercase">Soukromé · rodina Humlova</p>'
